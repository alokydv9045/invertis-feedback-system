          ...
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-8 max-w-6xl w-full mx-auto">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <h1 className="text-2xl sm:text-3xl font-semibold">Directory Hub</h1>
              </div>
            ...
            {msg.text && (
              <div className={`p-5 rounded-2xl text-sm font-semibold border shadow-sm ${
                msg.type === 'error'
            ...
            <div className="flex gap-4 border-b border-slate-200 dark:border-slate-800 flex-nowrap overflow-x-auto no-scrollbar pb-1">
              {TABS.map(({ id, label, icon: Icon }) => (
                <button
                  ...
                  className={`flex items-center gap-2.5 px-4 sm:px-6 py-4 text-xs sm:text-sm font-semibold border-b-2 transition -mb-px cursor-pointer uppercase tracking-widest whitespace-nowrap flex-shrink-0 ${
                    activeTab === id
            ...
            {loading ? (
              <div className="card-main p-24 flex flex-col items-center gap-4">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-600 dark:text-slate-400 animate-pulse">Syncing Directory...</span>
              </div>
            ) : (
              <div className="flex flex-col gap-8">
                ...
                {activeTab === 'departments' && (
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="card-main flex flex-col gap-6 h-fit">
                      <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] flex items-center gap-2 text-sm uppercase tracking-wider"><Plus size={18} className="text-primary-500" /> New Department</h3>
                      <form onSubmit={handleCreateDept} className="flex flex-col gap-4">
                        ...
                        <button type="submit" className="w-full bg-primary-600 hover:bg-primary-500 text-white py-4 font-semibold rounded-2xl text-xs uppercase tracking-widest transition-all shadow-lg shadow-primary-500/20 cursor-pointer active:scale-95">Add Department</button>
                      </form>
                    </div>
                    <div className="lg:col-span-2 flex flex-col gap-6">
                      <div className="flex items-center justify-between mb-2 px-2">
                        <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] text-sm flex items-center gap-2 uppercase tracking-wider"><Building2 size={18} className="text-primary-500" /> Registered Entities</h3>
                        <span className="text-[10px] font-semibold bg-primary-50 dark:bg-primary-900/40 text-primary-600 dark:text-primary-300 border border-primary-100 dark:border-primary-800/40 px-3 py-1 rounded-full uppercase tracking-widest">{departments.length} Units</span>
                      </div>
                          ...
                          >
                            ...
                            <div className="flex items-center gap-5">
                              ...
                              <div className="flex-1 min-w-0">
                                <h3 className="font-semibold text-slate-900 dark:text-white text-base truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{d.name}</h3>
                                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest border border-slate-200/50 dark:border-slate-700/50 mt-1.5">
                                  {d.code}
                                </div>
                              </div>
                            </div>
                ...
                {activeTab === 'courses' && (
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="card-main flex flex-col gap-6 h-fit">
                      <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] flex items-center gap-2 text-sm uppercase tracking-wider"><Plus size={18} className="text-primary-500" /> New Course</h3>
                      <form onSubmit={handleCreateCourse} className="flex flex-col gap-4">
                        ...
                        <button type="submit" className="w-full bg-primary-600 hover:bg-primary-500 text-white py-4 font-semibold rounded-2xl text-xs uppercase tracking-widest transition-all shadow-lg shadow-primary-500/20 cursor-pointer active:scale-95">Add Course</button>
                      </form>
                    </div>
                    <div className="lg:col-span-2 flex flex-col gap-6">
                      <div className="flex items-center justify-between mb-2 px-2">
                        <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] text-sm flex items-center gap-2 uppercase tracking-wider"><BookOpen size={18} className="text-primary-500" /> Academic Catalog</h3>
                        <span className="text-[10px] font-semibold bg-primary-50 dark:bg-primary-900/40 text-primary-600 dark:text-primary-300 border border-primary-100 dark:border-primary-800/40 px-3 py-1 rounded-full uppercase tracking-widest">{courses.length} Courses</span>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {courses.map(c => (
                          <motion.div
                          ...
                          >
                            ...
                            <div className="flex items-center gap-5">
                              ...
                              <div className="flex-1 min-w-0">
                                <h3 className="font-semibold text-slate-900 dark:text-white text-base truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{c.name}</h3>
                                <div className="flex items-center gap-3 mt-2">
                                  <span className="text-[9px] font-semibold text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-950/30 px-2.5 py-1 rounded-lg border border-primary-100 dark:border-primary-800/30 uppercase tracking-tighter">{c.code}</span>
                                  <span className="text-[10px] text-slate-600 dark:text-slate-400 font-semibold truncate uppercase tracking-widest">{c.department_name}</span>
                                </div>
                              </div>
                            </div>
                          </motion.div>
                ...
                {activeTab === 'faculty' && (
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="card-main flex flex-col gap-6 h-fit">
                      <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] flex items-center gap-2 text-sm uppercase tracking-wider"><Plus size={18} className="text-primary-500" /> New Faculty</h3>
                      ...
                      <form onSubmit={handleCreateFaculty} className="flex flex-col gap-4">
                        ...
                        <button type="submit" className="w-full bg-primary-600 hover:bg-primary-500 text-white py-4 font-semibold rounded-2xl text-xs uppercase tracking-widest transition-all shadow-lg shadow-primary-500/20 cursor-pointer active:scale-95">Add Faculty</button>
                      </form>
                    </div>
                    <div className="lg:col-span-2 flex flex-col gap-6">
                      <div className="flex items-center justify-between mb-2 px-2">
                        <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] text-sm flex items-center gap-2 uppercase tracking-wider"><Users size={18} className="text-primary-500" /> Faculty Directory</h3>
                        <span className="text-[10px] font-semibold bg-primary-50 dark:bg-primary-900/40 text-primary-600 dark:text-primary-300 border border-primary-100 dark:border-primary-800/40 px-3 py-1 rounded-full uppercase tracking-widest">{faculty.length} Records</span>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {faculty.map(f => (
                          <motion.div
                          ...
                          >
                            ...
                            <div className="flex items-center gap-5">
                              ...
                              <div className="flex-1 min-w-0">
                                <h3 className="font-semibold text-slate-900 dark:text-white text-base truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{f.name}</h3>
                                <div className="text-[10px] text-slate-600 dark:text-slate-400 font-semibold uppercase tracking-[0.1em] mt-2">{f.department_name}</div>
                              </div>
                            </div>
                          </motion.div>
                        ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="card-main flex flex-col gap-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] uppercase tracking-wider">Export Ledger</h3>
                          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Securely download the entire system state.</p>
                        </div>
                      </div>
                      <button onClick={handleExportData} className="w-full bg-primary-600 hover:bg-primary-500 text-white font-semibold py-4.5 rounded-2xl text-xs flex items-center justify-center gap-3 cursor-pointer uppercase tracking-widest transition-all shadow-xl shadow-primary-500/20 active:scale-95">
                    ...
                    <div className="card-main flex flex-col gap-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] uppercase tracking-wider">State Synchronizer</h3>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {['merge', 'overwrite'].map(m => (
                          <button key={m} onClick={() => setSyncMode(m)} className={`py-3.5 px-4 rounded-2xl border text-[10px] font-semibold transition-all cursor-pointer uppercase tracking-widest ${syncMode === m ? 'bg-primary-600 border-primary-600 text-white shadow-lg shadow-primary-500/20' : 'bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400'}`}>
                            {m === 'merge' ? 'Merge (Add)' : 'Full Wipe & Set'}
                          </button>
                        ))}
                      </div>
                      <button onClick={handleImportData} disabled={!importFile} className={`w-full font-semibold py-4.5 rounded-2xl text-xs flex items-center justify-center gap-3 cursor-pointer uppercase tracking-widest transition-all ${importFile ? 'bg-emerald-600 hover:bg-emerald-500 text-white shadow-xl shadow-emerald-500/20 active:scale-95' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 cursor-not-allowed'}`}>
