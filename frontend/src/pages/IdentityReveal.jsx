        ...
        <main className="flex-1 p-4 sm:p-6 md:p-8 overflow-auto">
          ...
          >
            ...
            <div className="flex items-center gap-3 sm:gap-4 flex-wrap sm:flex-nowrap justify-between">
              ...
              {searchCount > 0 && (
                <div className="flex items-center gap-1.5 text-[10px] font-semibold text-amber-400 bg-amber-500/10 border border-amber-500/20 px-3 py-1.5 rounded-xl flex-shrink-0">
            ...
            <div className="card-main p-6">
              <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-widest block mb-3">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-100 dark:bg-slate-900/80 border border-slate-300 dark:border-white/10 rounded-xl pl-11 pr-4 py-3.5
                      text-base font-mono font-semibold text-emerald-600 dark:text-emerald-400 placeholder-slate-500 dark:placeholder-slate-600
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-base font-semibold text-amber-600 dark:text-amber-200">Student Record Found</h3>
                      <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">
                        A student record matching <span className="font-mono font-semibold text-emerald-600 dark:text-emerald-400">{query}</span> was located.
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-5 flex-wrap gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold text-emerald-500 dark:text-emerald-400 uppercase tracking-widest">Identity Revealed</span>
                      </div>
                    ...
                    <div className="flex items-center gap-4 mb-6 p-4 hover:bg-black/5 dark:hover:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/8">
                      <div className="h-14 w-14 bg-gradient-to-br from-primary-500 to-accent-600
                        rounded-2xl flex items-center justify-center text-2xl font-semibold text-white shadow-xl flex-shrink-0">
                        {result.name?.charAt(0).toUpperCase()}
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="text-xl font-semibold text-slate-900 dark:text-white truncate">{result.name}</div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <div className="flex flex-col gap-1.5 p-4 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-500/20 rounded-2xl">
                        <div className="flex items-center gap-2 text-[10px] font-semibold text-emerald-600 dark:text-emerald-500 uppercase tracking-widest">
                          <Hash size={11} /> Anonymous ID (Public)
                        </div>
                        <div className="font-mono font-semibold text-emerald-600 dark:text-emerald-400 text-lg tracking-widest truncate">
                      ...
                      <div className="flex flex-col gap-1.5 p-4 bg-accent-50 dark:bg-accent-950/30 border border-accent-500/20 rounded-2xl">
                        <div className="flex items-center gap-2 text-[10px] font-semibold text-accent-600 dark:text-accent-400 uppercase tracking-widest">
                          <GraduationCap size={11} /> Roll Number (Confidential)
                        </div>
                        <div className="font-mono font-semibold text-accent-600 dark:text-accent-300 text-lg truncate">
                          {result.student_id || '—'}
                        </div>
                      ...
                      <div className="flex flex-col gap-1.5 p-4 hover:bg-black/5 dark:hover:bg-white/5 border border-slate-200 dark:border-white/8 rounded-2xl truncate">
                        <div className="flex items-center gap-2 text-[10px] font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-widest">
                      ...
                      <div className="flex flex-col gap-1.5 p-4 hover:bg-black/5 dark:hover:bg-white/5 border border-slate-200 dark:border-white/8 rounded-2xl truncate">
                        ...
                        <div className={`text-sm font-semibold truncate ${result.status === 'active' ? 'text-emerald-600 dark:text-emerald-400' : 'text-amber-600 dark:text-amber-400'}`}>
