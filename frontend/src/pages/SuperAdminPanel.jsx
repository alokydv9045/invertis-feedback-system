...
import { Shield, Building2, UsersRound, Plus, Trash2, Check, X, Eye, EyeOff, GraduationCap, Search, UserCheck, Hash, RefreshCcw, AlertTriangle, ArrowUpCircle, History, Briefcase, ClipboardList } from 'lucide-react';

const TABS = [
  { id: 'departments', label: 'Departments', icon: Building2 },
  { id: 'hods', label: 'HODs', icon: Briefcase },
  { id: 'coordinators', label: 'Coordinators', icon: ClipboardList },
            ...
            {/* Header */}
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6 w-full">
                ...
                <button 
                  ...
                  className="flex items-center justify-center gap-3 px-6 py-3.5 bg-amber-500 hover:bg-amber-600 text-white font-semibold rounded-2xl text-[11px] uppercase tracking-widest transition-all shadow-lg shadow-amber-500/20 active:scale-95 group flex-shrink-0 w-full sm:w-auto cursor-pointer"
                >
            ...
            <div className="flex gap-2 border-b border-slate-200 dark:border-slate-800 flex-nowrap overflow-x-auto no-scrollbar pb-1">
              {TABS.map(({ id, label, icon: Icon }) => (
                <button key={id} onClick={() => setTab(id)}
                  className={`flex items-center gap-2.5 px-5 py-3 sm:py-4 text-xs sm:text-sm font-semibold border-b-2 transition -mb-[5px] cursor-pointer uppercase tracking-widest whitespace-nowrap flex-shrink-0 ${tab === id
                ...
                {tab === 'departments' && (
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="card-main flex flex-col gap-6">
                      <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] flex items-center gap-2 text-sm uppercase tracking-wider">
                      ...
                      <form onSubmit={(e) => { e.preventDefault(); createDept(); }} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="flex items-end">
                          <button type="submit" className="w-full bg-primary-600 hover:bg-primary-500 text-white py-4 font-semibold rounded-2xl text-xs uppercase tracking-widest transition-all shadow-lg shadow-primary-500/20 cursor-pointer active:scale-95">
                            + Create
                          </button>
                        </div>
                      </form>
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="flex items-center justify-between px-2">
                        <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] text-sm flex items-center gap-2 uppercase tracking-wider">
                          <Building2 size={18} className="text-primary-500" /> All Departments
                        </h3>
                        <span className="text-[10px] font-semibold bg-primary-50 dark:bg-primary-900/40 text-primary-600 dark:text-primary-300 border border-primary-100 dark:border-primary-800/40 px-3 py-1 rounded-full uppercase tracking-widest">
                          ...
                          >
                            ...
                            <div className="flex items-center gap-5">
                              ...
                              <div className="flex-1 min-w-0">
                                <h3 className="font-semibold text-slate-900 dark:text-white text-base truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                                  {d.name}
                                </h3>
                                <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest border border-slate-200/50 dark:border-slate-700/50">
                                    {d.code}
                                  </div>
                                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest border border-slate-200/50 dark:border-slate-700/50">
                ...
                {tab === 'hods' && (
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="flex items-center justify-between px-2">
                        <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] text-sm flex items-center gap-2 uppercase tracking-wider">
                          <Briefcase size={18} className="text-primary-500" /> All HODs
                        </h3>
                        <span className="text-[10px] font-semibold bg-primary-50 dark:bg-primary-900/40 text-primary-600 dark:text-primary-300 border border-primary-100 dark:border-primary-800/40 px-3 py-1 rounded-full uppercase tracking-widest">
                          {hods.length} Active
                        </span>
                ...
                {tab === 'coordinators' && (
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-6">
                      <div className="flex items-center justify-between px-2">
                        <h3 className="font-semibold text-slate-900 dark:text-[var(--text-main)] text-sm flex items-center gap-2 uppercase tracking-wider">
                          <ClipboardList size={18} className="text-primary-500" /> All Coordinators
                        </h3>
                        <span className="text-[10px] font-semibold bg-primary-50 dark:bg-primary-900/40 text-primary-600 dark:text-primary-300 border border-primary-100 dark:border-primary-800/40 px-3 py-1 rounded-full uppercase tracking-widest">
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="card-main flex flex-col gap-5">
                      <div className="flex items-center justify-between gap-4 flex-wrap">
                        <div>
                          <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Academic Session Promotion</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="flex items-end gap-2 md:justify-end">
                          <button
                            ...
                            className="px-5 py-3 rounded-2xl text-xs font-semibold uppercase tracking-widest bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 cursor-pointer"
                          >
                    ...
                    {promotionPreview && (
                      <div className="card-main flex flex-col gap-4">
                        <div className="flex items-center justify-between gap-3 flex-wrap">
                          <h4 className="font-semibold text-slate-900 dark:text-white text-sm uppercase tracking-wider">Promotion Preview</h4>
                          <button
                            onClick={executePromotion}
                            disabled={executeLoading || ((promotionPreview.summary?.to_promote || 0) + (promotionPreview.summary?.to_graduate || 0) === 0)}
                            className="px-5 py-3 rounded-2xl text-xs font-semibold uppercase tracking-widest bg-primary-600 hover:bg-primary-500 disabled:opacity-50 text-white cursor-pointer"
                          >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 p-4">
                            ...
                            <div className="text-xl font-semibold text-[#1D3557] dark:text-white">{promotionPreview.summary?.students_scanned || 0}</div>
                          </div>
                          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 p-4">
                            <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold">To Promote</div>
                            <div className="text-xl font-semibold text-[#1D3557] dark:text-white">{promotionPreview.summary?.to_promote || 0}</div>
                          </div>
                          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 p-4">
                            <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold">To Graduate</div>
                            <div className="text-xl font-semibold text-[#1D3557] dark:text-white">{promotionPreview.summary?.to_graduate || 0}</div>
                          </div>
                          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 p-4">
                            <div className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-bold">Skipped</div>
                            <div className="text-xl font-semibold text-[#1D3557] dark:text-white">{promotionPreview.summary?.skipped || 0}</div>
                          </div>
                        </div>

                        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 p-4">
                          <h5 className="text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-widest mb-3">Semester Mapping</h5>
                    ...
                    <div className="card-main">
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <h4 className="font-semibold text-slate-900 dark:text-white text-sm uppercase tracking-wider">Promotion History</h4>
                      </div>
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <div className="card-main border border-primary-500/20 bg-gradient-to-br from-primary-50/50 via-transparent to-transparent dark:from-primary-950/20 dark:via-transparent dark:to-transparent">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-lg text-slate-900 dark:text-white">Student Directory</h3>
                          ...
                          >
                            ...
                            <div className="flex items-start justify-between gap-3">
                              <div className="flex-1 flex flex-col gap-1.5">
                                ...
                                <span className="text-sm font-mono font-semibold text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-950/40 px-3 py-2 rounded-xl border border-primary-100 dark:border-primary-800/40">
                            ...
                            <div className="flex items-start justify-between gap-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                              {isRevealed ? (
                                <div className="flex flex-col gap-2 flex-1 min-w-0">
                                  ...
                                  <div>
                                    <div className="text-base font-semibold text-slate-900 dark:text-white truncate">{s.name}</div>
                      ...
                      <div className="card-main flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 disabled:opacity-40 disabled:cursor-not-allowed text-slate-700 dark:text-slate-300 text-[10px] font-semibold rounded-xl uppercase tracking-widest transition-all"
                          >
                            Prev
                          </button>
