          ...
          >
            <div>
              <button
                ...
                className="hidden md:flex items-center gap-1.5 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition mb-6 cursor-pointer uppercase tracking-widest"
              >
            ...
            {loading ? (
              <div className="bg-white dark:bg-slate-900/50 p-24 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center min-h-[400px] shadow-sm">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-600 dark:text-slate-400 animate-pulse">Scanning Forms...</span>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900/50 p-12 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center justify-center min-h-[400px] gap-6 shadow-sm">
                ...
                <div>
                  <h3 className="font-semibold text-xl text-slate-900 dark:text-[var(--text-main)] mb-2">Evaluations Missing</h3>
                ...
                <button
                  onClick={() => navigate('/dashboard')}
                  className="mt-4 bg-primary-600 dark:bg-primary-500 text-white font-semibold px-8 py-4 rounded-2xl text-xs uppercase tracking-widest shadow-xl shadow-primary-500/20 hover:bg-primary-700 transition cursor-pointer"
                >
                  Return to Dashboard
                </button>
              </div>
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
                  <h3 className="font-semibold text-slate-900 dark:text-slate-700 dark:text-slate-300 text-xs uppercase tracking-[0.15em]">
                    Available Forms ({evaluations.length})
                  </h3>
                  <span className="text-[10px] text-slate-600 dark:text-slate-400 font-semibold uppercase tracking-widest">Select form to begin</span>
                </div>
                    ...
                    >
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between flex-1 gap-6 mr-6">
                          <div>
                             <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 px-3 py-1 rounded-lg border border-primary-100 dark:border-primary-800/30">
                              Form Identifier #{idx + 1}
                            </span>
                            <h2 className="text-xl md:text-2xl font-semibold text-slate-900 dark:text-[var(--text-main)] mt-3 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                              {ev.title}
                            </h2>
                          </div>
                          <div className="flex items-center gap-2 flex-shrink-0">
                            {ev.completed ? (
                              <span className="flex items-center gap-2 text-[10px] font-semibold uppercase tracking-widest text-emerald-600 bg-emerald-50 dark:bg-emerald-950/30 px-4 py-2 rounded-xl border border-emerald-100 dark:border-emerald-900/50 shadow-sm">
                                <CheckCircle2 size={14} /> Completed
                              </span>
                            ) : (
                              <span className="flex items-center gap-2 text-[10px] font-semibold uppercase tracking-widest text-amber-600 bg-amber-50 dark:bg-amber-950/30 px-4 py-2 rounded-xl border border-amber-100 dark:border-amber-900/50 shadow-sm animate-pulse">
                                Active Input
                              </span>
                            )}
                          </div>
                          ...
                          >
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-slate-100 dark:border-slate-800">
                              <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                                ...
                                <div>
                                  <p className="text-[10px] font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-500 dark:text-slate-400 uppercase tracking-widest">Course Module</p>
                                  <h4 className="text-sm font-semibold text-slate-900 dark:text-[var(--text-main)]">
                              ...
                              <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                                ...
                                <div>
                                  <p className="text-[10px] font-semibold text-slate-600 dark:text-slate-400 dark:text-slate-500 dark:text-slate-400 uppercase tracking-widest">Instructor Record</p>
                                  <h4 className="text-sm font-semibold text-slate-900 dark:text-[var(--text-main)]">
                                    {ev.faculty_name}
                                  </h4>
                                </div>
                            ...
                            <div className="flex gap-4 pt-2">
                              <button
                                ...
                                className="flex-1 flex items-center justify-center gap-3 bg-primary-600 dark:bg-primary-500 hover:bg-primary-700 dark:hover:bg-primary-600 text-white font-semibold py-4 px-10 rounded-2xl text-xs uppercase tracking-widest transition shadow-xl shadow-primary-500/20 cursor-pointer"
                              >
